...
public class DiagnosisEngineTest {
	...
	public void testEngine() {
		...
		DiagnosisEngineConfiguration<String, DefaultSessionResult<String>> configuration = new DiagnosisEngineConfiguration<String, DefaultSessionResult<String>>().setNumSessionWorkers(1)
				.setNumRuleWorkers(1).setRuleClasses(R1.class, R2.class, R3.class, R4.class).setStorageClass(DefaultRuleOutputStorage.class)
		...
		try {
			...
			Assert.assertEquals(results.get(0).getEndTags().get("Tag4").size(), 1);
		} catch (Exception e) {
	...
	public static class R4 {
		...
		@Action(resultTag = "Tag4")
		public String action() {
			return "EnhancedForNoNumbers";
		}
	}
}