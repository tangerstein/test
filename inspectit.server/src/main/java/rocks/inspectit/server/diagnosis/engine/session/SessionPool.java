...
public class SessionPool<I, R> extends GenericObjectPool<Session<I, R>> {
	...
	/**
	 * Since we want to activate out Session objects with parameters we need to add an additional
	 * borrowObject method. This method used internally the GenericObjectPool#borrowObject method,
	 * but invokes the parametrized {@link Session#activate(Object, SessionVariables)} method to
	 * ensure a proper activation of the {@link Session}.
	 *
	 * @param input
	 *            The input object to analyzed
	 * @param variables
	 *            The {@link SessionVariables} valid for this session execution.
